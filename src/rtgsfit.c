...
// input flux_total, flux_lcfs, flux_axis, mask
// output flux_norm
void normalise_flux(
        double* flux_total,
        double flux_lcfs,
        ...
        )
{
    ...
    int xpt_n = 0;
    int opt_n = 0;
    printf("in rtgsfit %lf %lf %lf %lf %lf %lf %lf %lf\n", coil_curr[0], coil_curr[1], coil_curr[2], coil_curr[3], coil_curr[4], coil_curr[5], coil_curr[6], *error);
